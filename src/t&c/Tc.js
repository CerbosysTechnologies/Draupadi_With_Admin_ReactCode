...
Throughout this document, “we”, “us”, “our”, “ours” refer to Draupadi. Wherever we have said ‘you’ or ‘your’, this means YOU
</p> 
<br/><span><b>ROLES WE PLAY</b></span><br/>
...
PERSONAL INFORMATION GATHERED BY DRAUPADI
The information we learn and gather from you, personal or otherwise, is used to register you, verify your identity to permit you to use the app, undertake transactions (including to facilitate and process payments), communicate with you, convey any promotional offers, services or updates associated with Draupadi, and generally maintain your accounts with us. We also use this information to customize your experience and improve Draupadi’s operations.
</p>
<br/><br/> <b>INFORMATION YOU GIVE US:</b><br/>
<p className="peragraph">
We receive and store any information you provide while using Draupadi, or give us in any other way. You can choose not to provide certain information, but then you might not be able to use Draupadi. We use the information that you provide for such purposes as opening your account, processing your transactions, responding to your requests, and communicating with you
</p>
...
<br/><br/><b> INFORMATION FROM OTHER SOURCES: </b> <br/>
<p className="peragraph">
...
<br/><br/><b> CATEGORIES OF PERSONAL DATA </b> <br/>
<p className="peragraph">
Categories of Personal Data collected and processed by us are as follows;
</p>
<br/><b> Demographic & Identity data </b> <br/>
<p className="peragraph">
•	Contact details such as Name, email address, contact number, shipping address, country, date of birth, profile picture
<br/>•	Open data and public records such as information about YOU that is openly available on the internet
<br/>•	Details such as Transaction amount, Bank Name, Card Type, Card number.
 Identifiers and other Technical Data
<br/>•	Location details such as data we get about your location, IP address, logs, or from where you connect a computer to the internet
<br/>•	Technical details such as device information, location and network carrier when you use our mobile applications
<br/>•	Communications details such as the Metadata and other Personal Data we get from communications done through e-mails, SMS, instant messages and calls
<br/>•	Usage data details such as data about how you use our website or web-based properties, pages viewed, etc.
CONSENT
...
<br/><br/><b>Provide, Troubleshoot, And Improve Draupadi</b> <br/>
We use your personal information to provide functionality, analyze performance, fix errors, and improve the usability and effectiveness of DRAUPADI.
<br/><br/><b>Recommendations And Personalization</b> <br/>
We use your personal information to recommend features, products, and services that might be of interest to you, identify your preferences, and personalize your experience with DRAUPADI.
<br/><br/><b>Communicate With You</b> <br/>
We use your personal information to communicate with you in relation to DRAUPADI via different channels (e.g., by phone, e-mail, chat).
...
<br/><br/><b>Lawful Bases of Processing Your Personal Data</b> <br/>
...
<br/>•	The processing is necessary to perform the agreement we have with you or to take steps to enter into an agreement with you
<br/>•	The processing is necessary to be in compliance with our Legal Obligations
<br/>•	The processing is necessary for the purposes of a legitimate interest (“Legitimate Interest”) pursued by us, such as
<br/>•	to provide services to you,
<br/>•	to evaluate, develop or improve our products and services
...
<br/><br/>
<b>COOKIES AND OTHER TRACKERS USED BY OUR DIGITAL PROPERTIES </b><br/>
<p className="peragraph">
...
<br/>•	Your user ID on the log on page
<br/>•	Your region or country
<br/>•	Your preferred language
<br/>•	Accessibility options like large font or high contrast pages
<br/><br/>
<b>Performance</b><br/>
These cookies tell us how you and our other customers use our website. We combine all this data together and study it.
<br/><br/> This helps us to:
<br/>•	Improve the performance of our services
<br/>•	Improve the products we provide
...
Draupadi app contains third party SDKs that collect personally identifiable information (PII). They use this information to better target users or provide elements of our products & services on behalf of us. These third-party sites have separate and independent privacy policies.
<br/><br/>DRAUPADI USES THREE TYPES OF SDKS:
SDKs	Purpose
Analytics	
<br/>•	Analyze in-depth detail about the visitors on our app
<br/>•	Settle errors
<br/>•	Better target users and
<br/>•	Provide push notifications and digital ads to the users Payment	
<br/>•	Complete customers’ payment transaction through Razorpay Login	
<br/>•	Help users to login at Draupadi Example - Google, Facebook.
<br/><br/>
...
Reasons for disclosing your Personal Data to other parties:<br/><br/>
We may disclose your Personal Data to others where it is lawful to do so including where we or they:
<br/>•	need to provide you with products or services
<br/>•	where you have initiated a payment
<br/>•	have a legal obligation to do so, e.g., to assist with detecting and preventing fraud,
<br/>•	have requirement in connection with regulatory reporting, litigation or asserting or defending legal rights and interests
<br/>•	have a legitimate business reason for doing so
<br/>•	want to send you information and promotional material regarding our products and services,
<br/>•	have asked you for your consent to share it, and you’ve agreed
<br/>•	Improve your online experience for using our product.
...
<br/>•	Other group companies and any subcontractors, agents or service providers who work for us or provide services to us or group companies (including their employees, sub-contractors, service providers, directors and officers)
<br/>•	Law Enforcement Authorities, Government Authorities, courts, dispute resolution bodies, our regulators, auditors and any party appointed or requested by our regulators to carry out investigations or audits of our activities
<br/>•	Statutory and regulatory bodies and authorities (including the government) investigating agencies and entities or persons, to whom or before whom it is mandatory to disclose the Personal Data as per the applicable law, courts, judicial and quasi-judicial authorities and tribunals, arbitrators and arbitration tribunals
<br/>•	Overseas regulators
<br/>•	Anybody else that we’ve been instructed to share your Personal Data with by you
CROSS-BORDER DATA TRANSFER<br/><br/>
...
<br/><br/><b>RETENTION AND DISPOSAL OF DATA</b><br/>
...
Our website may contain links to websites of other organizations. This privacy policy does not cover how that organization processes Personal Data. We encourage you to read the privacy policies on the other websites you visit.
