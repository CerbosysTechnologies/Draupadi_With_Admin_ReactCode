      ...
      <ProductWrapper className="home-product-div">
        {
          ...
          <ProductCard>
            <Link to="/products">
              <div>
                <ProductImg src = {product1} alt="DP"></ProductImg>
                <ProductImg src = {product2} alt="DP"></ProductImg>
                <ProductImg src = {product3} alt="DP"></ProductImg>
                <ProductImg src = {product4} alt="DP"></ProductImg>
                <ProductImg src = {product5} alt="DP"></ProductImg>
                <ProductImg src = {product6} alt="DP"></ProductImg>
              </div>
            </Link>
          </ProductCard>
            {/* <div className="flex">
